...
class ContextAnalyzer:
    ...
    def _assess_template_relevance(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        relevance = {"score": 0.0, "matching_templates": [], "adaptations_needed": []}
    ...
    async def _get_ai_insights(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                insights = {
                    "challenges": [
                        "Complex requirements may need iterative refinement"
                    ],
                    "suggestions": [
                        "Use structured approach with clear data relationships"
                    ],
            ...
            return {"challenges": [], "suggestions": [], "best_practices": []}
