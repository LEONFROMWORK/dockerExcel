...
class VBAAnalyzerBenchmark:
    ...
    def create_test_excel_with_vba(self, num_modules: int, lines_per_module: int) -> str:
        ...
        for num_modules, lines_per_module in test_configs:
            ...
            try:
                ...
                self.results.append({
                    ...
                    'avg_time': avg_time,
                    'errors_found': result.get('summary', {}).get('total_errors', 0)
                })
    ...
    def print_summary(self):
        ...
        if self.results:
            ...
            for result in self.results:
                print(f"{result['modules']:<10} {result['lines_per_module']:<12} "
