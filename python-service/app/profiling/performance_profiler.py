...
try:
    ...
    logger.warning("line_profiler not available. Install with: pip install line_profiler")
...
class PerformanceProfiler:
    ...
    def __init__(self, enable_line_profiling: bool = True, 
        ...
        self.line_profiler = line_profiler.LineProfiler() if self.enable_line_profiling else None
    ...
    def profile_function(self, func: Callable = None, *, 
        ...
        def decorator(f):
            # 라인 프로파일링 추가
            if (include_line_profiling and self.enable_line_profiling 
    ...
    def profile_method(self, include_line_profiling: bool = True,
                      include_memory_profiling: bool = True):
        """메서드 프로파일링 데코레이터"""
    ...
    def _profile_execution(self, func: Callable, args: tuple, kwargs: dict,
                          include_memory_profiling: bool = True) -> Any:
        """함수 실행 프로파일링"""
        ...
        if include_memory_profiling and self.enable_memory_profiling:
            ...
            memory_monitor = threading.Thread(
                ...
                args=(stop_monitoring, lambda: memory_peak)
            )
    ...
    def _analyze_bottlenecks(self) -> List[Dict[str, Any]]:
        ...
        # 실행 시간 기준 병목 지점
        sorted_by_time = sorted(self.metrics, key=lambda m: m.execution_time, reverse=True)
    ...
    def _generate_recommendations(self) -> List[str]:
        ...
        repeated_functions = [(func, count) for func, count in function_calls.items() if count > 10]
        ...
        high_cpu_functions = [
            ...
            if m.cpu_usage_after - m.cpu_usage_before > 50
        ]
    ...
    def get_summary_stats(self) -> Dict[str, Any]:
        ...
        memory_deltas = [m.memory_usage_after - m.memory_usage_before for m in self.metrics]
