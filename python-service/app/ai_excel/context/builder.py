...
class ContextBuilder:
    ...
    def build(
        self, user_request: str, additional_context: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
    ...
    def _merge_contexts(
        self, parsed: Dict[str, Any], additional: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _apply_domain_defaults(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if domain and domain in self.domain_defaults:
            ...
            for key, value in defaults.items():
                if (
                    key not in ["default_sheets", "required_columns"]
