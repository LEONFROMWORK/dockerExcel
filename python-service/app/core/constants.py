...
def get_processing_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "enable_parallel_processing": get_threshold_value(
            EnvironmentKeys.ENABLE_PARALLEL_PROCESSING, True
        ),
        "enable_style_caching": get_threshold_value(
            EnvironmentKeys.ENABLE_STYLE_CACHING, True
        ),
        "conversion_timeout": get_threshold_value(
            "EXCEL_CONVERSION_TIMEOUT", PerformanceSettings.CONVERSION_TIMEOUT
        ),
    }
