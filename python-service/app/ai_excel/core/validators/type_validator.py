...
class TypeValidator:
    ...
    def validate(self, series: pd.Series, expected_type: DataType) -> List[Tuple[int, str]]:
    ...
    def _validate_phone(self, value: Any) -> str:
        ...
        if (re.match(self.patterns["phone_kr"], value_str) or 
            re.match(self.patterns["phone_us"], value_str)):
            return None
