...
class ProgressTracker:
    ...
    def create_task(self, task_id: str, filename: str, user_id: Optional[str] = None) -> Dict[str, Any]:
        """새로운 처리 작업 생성"""
    ...
    def update_progress(self, task_id: str, stage: ProcessingStage, 
                       operation: str = None, progress_detail: Dict[str, Any] = None) -> Dict[str, Any]:
        """진행률 업데이트"""
    ...
    def fail_task(self, task_id: str, error_message: str, error_detail: Dict[str, Any] = None) -> Dict[str, Any]:
        """작업 실패 처리"""
