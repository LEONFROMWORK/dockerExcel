...
from app.services.i18n_service import I18nService, i18n_service, get_text, get_error_message
...
class TestI18nService:
    ...
    def test_accept_language_parsing(self):
        ...
        for accept_language, expected in test_cases:
            ...
            assert result == expected, f"Expected {expected}, got {result} for {accept_language}"
    ...
    def test_multiple_language_workflow(self):
        ...
        for lang in languages:
            results[lang] = {
                ...
                "sheets": i18n_service.get_text("excel.analysis.sheets_found", lang, count=file_info["sheet_count"]),
                "formulas": i18n_service.get_text("excel.analysis.formulas_found", lang, count=file_info["formula_count"]),
                "errors": i18n_service.get_text("excel.analysis.errors_found", lang, count=file_info["error_count"])
            }
