        ...
        try:
            async with httpx.AsyncClient() as client:
                ...
                if response.status_code == 200:
                    ...
                    logger.error(f"Failed to fetch file from Rails: {response.status_code}")
                    return None
        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                with open(tmp_path, 'rb') as f:
                    files = {"file": ("updated.xlsx", f, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")}
    ...
    async def get_file_info(self, file_id: str) -> Optional[WOPIFile]:
        ...
        try:
            return WOPIFile(
                ...
                last_modified=datetime.fromisoformat(file_data.get('updated_at', datetime.now().isoformat())),
