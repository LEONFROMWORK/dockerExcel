        ...
        for row in range(1, min(31, ws.max_row + 1)):
            for col in range(1, min(20, ws.max_column + 1)):
                ...
                if (
                    ...
                    or cell.fill.start_color.index not in [None, "00000000"]
                    ...
                    if any(
                        ...
                        style_info["border"] = {
                            ...
                            "bottom": {
                                ...
                                "color": (
                                    cell.border.bottom.color.index
...
if __name__ == "__main__":
    ...
    with open(
        "/Users/kevin/Desktop/excel_structure_analysis.json", "w", encoding="utf-8"
    ) as f:
