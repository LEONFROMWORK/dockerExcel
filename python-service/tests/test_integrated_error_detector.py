...
class TestIntegratedErrorDetector:
    ...
    def detector(self, mock_progress_reporter):
        """감지기 인스턴스"""
        with patch('app.services.detection.integrated_error_detector.settings') as mock_settings:
    ...
    async def test_run_detectors_parallel(self, detector):
        ...
        # 여러 감지기 설정
        errors1 = [ExcelError(
            id="1", type="#DIV/0!", sheet="Sheet1", cell="A1",
            formula=None, value=None, message="", severity="high",
            is_auto_fixable=True, suggested_fix="", confidence=0.9
        )]
        
        errors2 = [ExcelError(
            id="2", type="Duplicate", sheet="Sheet1", cell="B2",
            formula=None, value="dup", message="", severity="medium",
            is_auto_fixable=False, suggested_fix="", confidence=0.8
        )]
    ...
    def test_deduplicate_errors(self, detector):
        ...
        errors = [
            ...
            ExcelError(
                id="2", type="#DIV/0!", sheet="Sheet1", cell="A1",  # 같은 위치, 같은 타입
                formula=None, value=None, message="", severity="high",
                is_auto_fixable=True, suggested_fix="", confidence=0.9
            ),
            ExcelError(
                id="3", type="#N/A", sheet="Sheet1", cell="A1",  # 같은 위치, 다른 타입
                formula=None, value=None, message="", severity="low",
                is_auto_fixable=True, suggested_fix="", confidence=0.8
            ),
        ]
    ...
    def test_sort_errors_by_priority(self, detector):
        ...
        errors = [
            ExcelError(
                id="1", type="#DIV/0!", sheet="Sheet2", cell="B2",
                formula=None, value=None, message="", severity="medium",
                is_auto_fixable=True, suggested_fix="", confidence=0.9
            ),
            ExcelError(
                id="2", type="#REF!", sheet="Sheet1", cell="A1",
                formula=None, value=None, message="", severity="critical",
                is_auto_fixable=False, suggested_fix="", confidence=0.7
            ),
            ExcelError(
                id="3", type="#N/A", sheet="Sheet1", cell="C3",
                formula=None, value=None, message="", severity="low",
                is_auto_fixable=True, suggested_fix="", confidence=0.8
            ),
        ]
    ...
    def test_create_summary(self, detector):
        ...
        errors = [
            ...
            ExcelError(
                id="2", type="#DIV/0!", sheet="Sheet1", cell="B1",
                formula=None, value=None, message="", severity="high",
                is_auto_fixable=True, suggested_fix="", confidence=0.9
            ),
            ExcelError(
                id="3", type="#N/A", sheet="Sheet2", cell="C1",
                formula=None, value=None, message="", severity="low",
                is_auto_fixable=False, suggested_fix="", confidence=0.8
            ),
        ]
