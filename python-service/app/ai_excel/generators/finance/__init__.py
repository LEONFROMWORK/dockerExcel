...
from ...structure.excel_schema import ExcelStructure, SheetSchema
...
class FinanceGenerator(BaseExcelGenerator):
    ...
    async def generate_data(self, structure: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, pd.DataFrame]:
        ...
        for sheet_spec in structure.get("sheets", []):
            ...
            if sheet_name == "손익계산서":
                ...
                periods = [col["name"] for col in sheet_spec["columns"] 
                ...
                data[sheet_name] = self._generate_balance_sheet_data(sheet_spec, context)
                ...
                data[sheet_name] = self._generate_generic_finance_data(sheet_spec, context)
    ...
    def _generate_balance_sheet_data(self, sheet_spec: Dict[str, Any], context: Dict[str, Any]) -> pd.DataFrame:
        """Generate balance sheet data (placeholder)"""
    ...
    def _generate_cash_flow_data(self, sheet_spec: Dict[str, Any], context: Dict[str, Any]) -> pd.DataFrame:
        """Generate cash flow data (placeholder)"""
    ...
    def _generate_generic_finance_data(self, sheet_spec: Dict[str, Any], context: Dict[str, Any]) -> pd.DataFrame:
        """Generate generic financial data"""
