...
class TableBuilder:
    ...
    def create_table(self, worksheet: Worksheet, config: TableConfig) -> Table:
        ...
        table = Table(displayName=config.table_name, ref=f"{config.start_cell}:{config.end_cell}")
    ...
    def create_table_legacy(self, worksheet: Worksheet, start_cell: str, end_cell: str, 
                           table_name: str, style: str = "TableStyleMedium9") -> Table:
    ...
    def add_data_validation(self, worksheet: Worksheet, config: ValidationConfig) -> None:
    ...
    def add_data_validation_legacy(
        self, worksheet: Worksheet, cell_range: str,
