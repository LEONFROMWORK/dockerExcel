...
class ConstraintValidator:
    ...
    def validate_range(self, series: pd.Series, column_name: str, 
                      min_val: Optional[Any], max_val: Optional[Any]) -> List[dict]:
    ...
    def validate_allowed_values(self, series: pd.Series, column_name: str, 
                               allowed_values: List[Any]) -> List[dict]:
