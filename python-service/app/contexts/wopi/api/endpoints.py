    ...
    try:
        ...
        return GenerateTokenResponse(
            ...
            access_token_ttl=int(
                (token.expires_at - token.created_at).total_seconds() * 1000
            ),
            wopi_src=wopi_src,
        )
...
async def stream_file(
    ...
    try:
        ...
        return StreamingResponse(
            stream_generator(), status_code=206 if range else 200, headers=headers
        )
