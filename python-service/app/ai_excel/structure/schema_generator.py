...
class SchemaGenerator:
    ...
    def _add_sum_formulas(
        self, structure: ExcelStructure, calc_spec: Dict[str, Any]
    ) -> None:
    ...
    def _determine_charts(
        self, sheet: SheetSchema, domain: Optional[str]
    ) -> List[Dict[str, Any]]:
    ...
    def _create_fallback_structure(self, context: Dict[str, Any]) -> ExcelStructure:
        ...
        sheet = SheetSchema(name="데이터", columns=columns, row_count=50)
    ...
    def _load_domain_templates(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "finance": {
                ...
                "metadata": {"standards": ["K-GAAP", "IFRS"], "period_type": "annual"},
            },
            "hr": {
                "sheet_formulas": {
                    "급여현황": [
                ...
                "metadata": {"privacy": "high", "compliance": ["Labor Standards Act"]},
            },
        }
